...
exports.genPathNice = void 0;
const fs_1 = __importDefault(require("fs"));
const chokidar_1 = __importDefault(require("chokidar"));
const util_js_1 = require("./util.js");
const copy_js_1 = require("./fs/copy.js");
const move_js_1 = require("./fs/move.js");
const remove_js_1 = require("./fs/remove.js");
const empty_dir_js_1 = require("./fs/empty-dir.js");
const ensure_js_1 = require("./fs/ensure.js");
function genPathNice(lowpath, fs) {
    function n(p) {
    ...
    function extract(p) {
        ...
        (0, util_js_1.checkCompatibility)({ lowpath, fs }, p);
        return p.raw;
    }
    class PathNice {
        constructor(raw) {
        ...
        static _from(path) {
            ...
            (0, util_js_1.checkCompatibility)({ lowpath, fs }, path);
        ...
        readFileToString(options) {
            ...
            else if (!(0, util_js_1.isValidBufferEncoding)(options.encoding)) {
        ...
        writeJSON(data, options) {
            const { json, writeOptions } = (0, util_js_1.toJsonAndWriteOptions)(data, options);
        ...
        async copy(dest, options) {
            dest = extract(dest);
            await (0, copy_js_1.copy)(lowpath, fs, this.raw, dest, options);
            return n(dest);
        }
        copySync(dest, options) {
            dest = extract(dest);
            (0, copy_js_1.copySync)(lowpath, fs, this.raw, dest, options);
            return n(dest);
        }
        async move(dest, options) {
            dest = extract(dest);
            await (0, move_js_1.move)(lowpath, fs, this.raw, dest, options);
            return n(dest);
        }
        moveSync(dest, options) {
            dest = extract(dest);
            (0, move_js_1.moveSync)(lowpath, fs, this.raw, dest, options);
            return n(dest);
        }
        ...
        async remove() {
            await (0, remove_js_1.remove)(fs, this.raw);
            return this;
        }
        removeSync() {
            (0, remove_js_1.removeSync)(fs, this.raw);
            return this;
        }
        async delete() {
            await (0, remove_js_1.remove)(fs, this.raw);
        ...
        async emptyDir() {
            await (0, empty_dir_js_1.emptyDir)(lowpath, fs, this.raw);
            return this;
        }
        emptyDirSync() {
            (0, empty_dir_js_1.emptyDirSync)(lowpath, fs, this.raw);
            return this;
        }
        async ensureDir(options) {
            await (0, ensure_js_1.ensureDir)(fs, this.raw, options);
            return this;
        }
        ensureDirSync(options) {
            (0, ensure_js_1.ensureDirSync)(fs, this.raw, options);
            return this;
        }
        async ensureFile(options) {
            await (0, ensure_js_1.ensureFile)(lowpath, fs, this.raw, options);
            return this;
        }
        ensureFileSync(options) {
            (0, ensure_js_1.ensureFileSync)(lowpath, fs, this.raw, options);
            return this;
        }
        exists() {
        ...
        watchWithChokidar(options) {
            if (fs !== fs_1.default && !(options === null || options === void 0 ? void 0 : options.forceEvenDifferentFS)) {
            ...
            return chokidar_1.default.watch(this.raw, options);
        }
        async fileOwner() {
    ...
    class PathNiceArr extends Array {
        ...
        watchWithChokidar(options) {
            ...
            return chokidar_1.default.watch(this.map((p) => p.raw), options);
        }
        // ===============================================================================
        // Array methods
        // ===============================================================================
...
exports.genPathNice = genPathNice;
