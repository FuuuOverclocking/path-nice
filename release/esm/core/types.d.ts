...
export declare type FileSystem = typeof nodefs;
export declare type PathFn = typeof path;
/**
...
export declare function path(path_0: string | PathNice, path_1: string | PathNice, ...paths_rest: (string | PathNice)[]): PathNiceArr;
export declare function path(paths: ReadonlyArray<string | PathNice> | PathNiceArr): PathNiceArr;
